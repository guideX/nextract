...
Begin VB.UserControl ctlButton 
   ...
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   229
   ToolboxBitmap   =   "ctlISButton.ctx":0000
...
Option Explicit
Private Const strCurrentVersion = "3.5.0"
...
Private Sub UserControl_Resize()
  ...
  DrawText UserControl.hdc, m_sCaption, Len(m_sCaption), tmpRect, DT_CALCRECT Or DT_WORDBREAK
  ...
  Select Case m_CaptionAlign
    ...
    Case isbleft
      ...
      SetRect m_txtRect, iStyleIconOffset, (lh - tmpRect.Bottom - tmpRect.Top) / 2, tmpRect.Right + iStyleIconOffset, (lh + tmpRect.Bottom - tmpRect.Top) / 2
...
OpenLink_Error:
End Function
' Fred.cpp  /   2005-July-5   /   4808 lines
